...
\end{minipage} & \begin{minipage}[t]{0.22\columnwidth}\raggedright
\href{}{Join our GitHub classroom by accepting first assignment}\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.22\columnwidth}\raggedright
Week 04\strut
\end{minipage} & \begin{minipage}[t]{0.22\columnwidth}\raggedright
...
\def\labelenumi{\arabic{enumi}.}
\item
  Access our \href{}{first assignment} and click on ``Accept this assignment''
\item
...
\def\labelenumi{\arabic{enumi}.}
\item
  Go to our \href{}{first assignment GitHub repository}
\item
...
Accept \href{}{data challenge 01 assignment}
