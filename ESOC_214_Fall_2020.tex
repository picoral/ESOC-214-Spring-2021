...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# check how many countries (categorical variable)}
\KeywordTok{unique}\NormalTok{(country_vaccinations}\OperatorTok{$}\NormalTok{country)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# check vaccines (categorical variable)}
\KeywordTok{unique}\NormalTok{(country_vaccinations}\OperatorTok{$}\NormalTok{vaccines)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{# get an overview of the data frame}
\NormalTok{country_vaccinations }\OperatorTok{%>%}\StringTok{ }
...
\begin{Highlighting}[]
\NormalTok{country_vaccinations }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(vaccines)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{country_vaccinations }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(vaccines) }\OperatorTok{%>%}
...
\begin{Highlighting}[]
\NormalTok{country_vaccinations }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{count}\NormalTok{(vaccines)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{country_vaccinations }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(vaccines) }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{total_days =} \KeywordTok{n}\NormalTok{(),}
            \DataTypeTok{total_per_hundred =} \KeywordTok{____}\NormalTok{(____), }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{country_vaccinations }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(country }\OperatorTok{==}\StringTok{ "United States"} \OperatorTok{|}
\StringTok{           }\NormalTok{country }\OperatorTok{==}\StringTok{ "Israel"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ date, }
             \DataTypeTok{y =}\NormalTok{ daily_vaccinations,}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-42-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-61-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-69-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-70-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-71-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-72-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-74-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-87-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-95-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-96-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-97-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-98-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-105-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-112-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-113-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-120-1.pdf}
...
## $ Name      <chr> "Per Knut Aaland", "Per Knut Aaland", "Per Knut Aaland", "Pe~
...
## $ Team      <chr> "United States", "United States", "United States", "United S~
...
## $ Sport     <chr> "Cross Country Skiing", "Cross Country Skiing", "Cross Count~
## $ Event     <chr> "Cross Country Skiing Men's 10 kilometres", "Cross Country S~
## $ Medal     <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, ~
## $ kg_per_cm <dbl> 0.3989362, 0.3989362, 0.3989362, 0.3989362, 0.3989362, 0.398~
\end{verbatim}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-123-1.pdf}

\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-124-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-142-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-144-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-145-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-146-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-160-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-168-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-178-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-179-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-180-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-181-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-182-1.pdf}
...
\caption{\label{tab:unnamed-chunk-193}Total number of beer awards per region (1987-2020)}
\centering
\begin{tabular}[t]{l|r}
\hline
...
\caption{\label{tab:unnamed-chunk-195}Average number of beer awards per state across regions}
\centering
\begin{tabular}[t]{l|r}
\hline
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-197-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-200-1.pdf}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-204-1.pdf}

\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-205-1.pdf}
...
\CommentTok{# data from https://www.kaggle.com/babyoda/women-entrepreneurship-and-labor-force}
\CommentTok{# read data in and clean column names}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# boxplot of level of development (binary) vs inflation rate}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# scatterplot with regression line of inflation rate}
\CommentTok{# vs entrepreneurship index}
\NormalTok{women_labor_force_data }\OperatorTok{%>%}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-210-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# run regression and get summary of results}
...
\CommentTok{# print our coefficients of regression results}
...
\begin{Highlighting}[]
\CommentTok{# scatterplot with regression line of inflation rate}
\CommentTok{# vs women entrepreneurship index}
\NormalTok{women_labor_force_data }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ inflation_rate,}
...
\includegraphics{ESOC_214_Fall_2020_files/figure-latex/unnamed-chunk-212-1.pdf}
